# ElectroTech
Este es un proyecto básico de un ecommerce del curso de react. Aqui podemos ver una lista de productos de una tienda de electronica y realizar compras. Los datos se almacenan en Firebase.
